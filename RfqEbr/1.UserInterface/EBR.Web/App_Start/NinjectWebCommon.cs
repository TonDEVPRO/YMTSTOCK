...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(EBR.Web.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(EBR.Web.App_Start.NinjectWebCommon), "Stop")]

namespace EBR.Web.App_Start
{
	using System;
	using System.Web;
	...
	public static class NinjectWebCommon
	{
		...
		{
			kernel.Bind<Factories>().To<Factories>()
					.InSingletonScope();
