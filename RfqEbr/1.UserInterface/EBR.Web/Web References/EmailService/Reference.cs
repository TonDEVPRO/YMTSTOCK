...
namespace EBR.Web.EmailService {
    ...
    public partial class Email : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Email() {
            this.Url = global::EBR.Web.Properties.Settings.Default.EBR_Web_EmailService_Email;
        ...
        public Message SendEmail(string subject, string message, string mailFrom, string mailTo, string mailCc) {
        ...
        /// <remarks/>
        public void SendEmailAsync(string subject, string message, string mailFrom, string mailTo, string mailCc) {
            this.SendEmailAsync(subject, message, mailFrom, mailTo, mailCc, null);
        }
        
        /// <remarks/>
        public void SendEmailAsync(string subject, string message, string mailFrom, string mailTo, string mailCc, object userState) {
            ...
            this.InvokeAsync("SendEmail", new object[] {
                        ...
                        mailFrom,
                        mailTo,
                        mailCc}, this.SendEmailOperationCompleted, userState);
        }
