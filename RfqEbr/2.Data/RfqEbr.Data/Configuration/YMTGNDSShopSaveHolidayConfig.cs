...
namespace RfqEbr.Data.Configuration
{
    ...
    public class YMTGNDSShopSaveHolidayConfig : EntityTypeConfiguration<YMTGNDSShopSaveHoliday>
    {

        public YMTGNDSShopSaveHolidayConfig()
        {
            ToTable("YMTG_NDSShop_Holiday");
