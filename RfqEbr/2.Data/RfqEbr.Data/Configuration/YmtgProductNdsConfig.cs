...
public class YmtgProductNdsConfig : EntityTypeConfiguration<YmtgProductNds>
{
    public YmtgProductNdsConfig()
    {
        // กำหนดชื่อของตาราง
        ToTable("YMTG_NDS_Product");
        ...
        Property(e => e.QuotationNumber).HasColumnName("QuotationNumber").HasMaxLength(255);
        ...
        Property(e => e.SKUCodeFull).HasColumnName("SKUCodeFull").HasMaxLength(100);
