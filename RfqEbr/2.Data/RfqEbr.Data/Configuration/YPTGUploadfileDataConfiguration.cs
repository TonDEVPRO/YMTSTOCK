...
namespace RfqEbr.Data.Configuration
{
    ...
    public class YPTGUploadfileDataConfiguration : EntityTypeConfiguration<YPTGUploadfileData>
    {

        public YPTGUploadfileDataConfiguration()
        {
            ToTable("YPTG_UploadfileData");
            // กำหนดชื่อของตาราง
