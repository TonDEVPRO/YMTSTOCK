...
namespace RfqEbr.Data.Helpers
{
    ...
    {
        public RepositoryProvider(Factories repositoryFactories)
        {
        ...
        /// of the injected <see cref="Factories"/>.
        /// </param>
        /// <remarks>
        ...
        /// <summary>
        /// The <see cref="Factories"/> with which to create a new repository.
        /// </summary>
        /// <remarks>
        /// Should be initialized by constructor injection
        /// </remarks>
        private readonly Factories _repositoryFactories;
